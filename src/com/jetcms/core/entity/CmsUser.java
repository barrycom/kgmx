...
public class CmsUser extends BaseCmsUser implements PriorityInterface {
	...
	public CmsUser(java.lang.Integer id,String username) {
		super(id,username);
	}
	/**
	...
	public CmsUser(java.lang.Integer id,
			...
			java.lang.Boolean disabled,java.lang.Integer createId,Double chargeAmount,java.lang.Boolean pay,String dynamicPass) {
