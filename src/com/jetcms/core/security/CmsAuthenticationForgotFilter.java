 ...
 */
public class CmsAuthenticationForgotFilter extends FormAuthenticationFilter {
	
	private Logger logger = LoggerFactory.getLogger(CmsAuthenticationForgotFilter.class);
	...
	protected boolean executeLogin(ServletRequest request,ServletResponse response) throws Exception {
		...
		//验证码校验
		 ...
		 if(StringUtils.isBlank(JedisUtils.get("back"+"-"+username))){
