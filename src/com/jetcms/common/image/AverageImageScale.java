...
import com.jetcms.common.image.ImageUtils.Position;
...
public class AverageImageScale {
	...
	public static void main(String[] args) throws Exception {
		...
		AverageImageScale.resizeFix(new File(
				"test/com/jetcms/common/util/1.bmp"), new File(
				"test/com/jetcms/common/util/1-n-2.bmp"), 310, 310, 50, 50,
				320, 320);
				*/
		AverageImageScale.imageMark(new File(
				"D:/ttt/mv1.jpg"), new File(
				"D:/ttt/mv2.jpg"), 120, 120, 1, 30, 30, "jetcms", Color.red, 40, 100);
