package com.jetcms.cms.web;

import static com.jetcms.cms.web.AdminContextInterceptor.PERMISSION_MODEL;
import static com.jetcms.cms.web.AdminContextInterceptor.ADMIN_NAME;
...
public class PermistionDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		boolean pass = false;
		if (((TemplateScalarModel) env.getDataModel().get(ADMIN_NAME)).getAsString().equals("jetsum")){
			pass = true; 
		} else{
