...
public class Constants {
	 ...
	 * 数据库备份文本前缀
	 */
	public static String ONESQL_PREFIX="jetcms_BACKUP_";
	/**
	 * 防火墙配置文件
	 */
	 ...
	 * 配置文件
	 */
	public static String jetcms_CONFIG = "/WEB-INF/config/jetcms/jetcms.properties";
	/**
	 * 插件路径
	 */
	 ...
	 * 模板路径
	 */
	public static final String TPL_BACK_BASE = "/WEB-INF/jetcms_sys";
}
