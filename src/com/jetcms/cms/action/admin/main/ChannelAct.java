...
import com.jetcms.common.util.ChineseCharToEn;
...
public class ChannelAct {
	...
	public String save(Integer root, Channel bean, ChannelExt ext,
		...
		bean = manager.save(bean, ext, txt, viewGroupIds, contriGroupIds,
				userIds, CmsUtils.getSiteId(request), root, modelId,workflowId,modelIds,tpls,mtpls,catalogNames, cataloglectureDates, catalogstartTimes, catalogendTimes,
				 catalogpaths,  viewCounts, courseCategorys,isFixeds);
	...
	public String update(Integer root, Channel bean, ChannelExt ext,
			...
			Integer modelId,HttpServletRequest request,ModelMap model,String[] catalogNames,String[] cataloglectureDates,String[] catalogstartTimes,String[] catalogendTimes,
			String[] catalogpaths, Integer[] viewCounts,String[] courseCategorys ,String[] isFixeds) {
		...
		bean = manager.update(bean, ext, txt, viewGroupIds, contriGroupIds,
				userIds, parentId, attr,modelId,workflowId,modelIds,tpls,mtpls,catalogNames, cataloglectureDates, catalogstartTimes, catalogendTimes,
				 catalogpaths,  viewCounts, courseCategorys,isFixeds);
